...
public class LayoutVisitor implements Visitor {
  ...
  private Polyline bridge (Polyline line1, int x1, int y1,
    ...
    public Object visitRecursiveCommand(RecursiveCommand ast, Object o) {
        return(layoutBinary("Rec.Com.", ast.D1, ast.D2));
    }

    @Override
    public Object visitRepeatWhileCommand(RepeatWhileCommand ast, Object o) {
        return layoutBinary("Rep.WhileCom.", ast.E, ast.C);
    }

    @Override
    public Object visitRepeatUntilCommand(RepeatUntilCommand ast, Object o) {
        return layoutBinary("Rep.UntilCom.", ast.E, ast.C);
    }

    @Override
    public Object visitRepeatDoWhileCommand(RepeatDoWhileCommand ast, Object o) {
        return layoutBinary("Rep.DoWhileCom.", ast.C, ast.E);
    }

    @Override
    public Object visitRepeatDoUntilCommand(RepeatDoUntilCommand ast, Object o) {
        return layoutBinary("Rep.DoUntilCom.", ast.C, ast.E);
    }
